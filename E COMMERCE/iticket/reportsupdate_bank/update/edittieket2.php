...
if(isset($_POST['ishir']))   //ishir Check
		...
		$_POST['amount']."', `details` = '".$_POST['editor1']."', `status` = '".$_POST['status']."', `superiors` = '".$data_array[16]."',\"".	
		...
		'group']."', `cus_contact` = '".$_POST['cus_phone']."',   				
		`cus_name` = '".$_POST['cus_name']."', `cus_ac` = '".$_POST['account_id']."', `cus_product` = '".$_POST['product']."', `cus_amount` = '".	
		$_POST['amount']."', `details` = '".$_POST['editor1']."', `status` = '".$_POST['status']."', `superiors` = '".$data_array[16]."' WHERE `ticket`.`id` = $Global_id");
