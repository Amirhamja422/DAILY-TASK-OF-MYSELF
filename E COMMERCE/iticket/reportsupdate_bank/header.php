                    ...
                    <ul class="navbar-nav ml-auto">
                        <!-- Authentication Links -->
                            ...
                            <!-- <li class="nav-item dropdown">
                                <a class="nav-link" onclick="location.href='out.php?i=<?php print $_GET['i'];?>'" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre style="color: red;">
                                    Logout(<?php echo $_SESSION['usr01937417227']; ?>) &nbsp;
                                </a>
                            </li> -->
