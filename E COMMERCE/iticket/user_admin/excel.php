...
$DB_TBLName = "excel";				//your MySQL Table Name 
...
$sql = "SELECT number as 'Number' FROM `excel` where `tracking_id` = '".$q1."' && `status` = 'GOOD'";
...
header("Content-Disposition: attachment; filename=Lead_Filter.$file_ending");
