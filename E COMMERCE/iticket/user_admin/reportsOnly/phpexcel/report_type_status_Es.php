...
$filename="iTicket_Report(Ticket-Escalation)_PRAN-RFL_CRD".date("Y-m-d");							//File Name to be Exported
$topgap=2;										//Line Gap in Excel File Top (Must Greater than 1)
$color='F28A8C';
$color2='FFFFFF';

 
 $sql = "select * from history where id in (select id from ticket where ticket_type = '$q3' ) and date >='$q1 00:00:00'  AND date <='$q2 23:59:59' ORDER BY `history`.`id` ASC"; 
