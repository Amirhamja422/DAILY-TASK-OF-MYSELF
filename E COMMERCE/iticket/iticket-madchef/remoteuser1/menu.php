...
?></span>
	  ...
	  &nbsp;<button class="btn btn-danger btn-sm" onclick="location.href='../admin/out.php?i=<?php print $_GET['i'];?>'" > <span class="glyphicon glyphicon-off" aria-hidden="true"></span>&nbsp;Log out</button> </td>
    </tr>
  </table>
</div>
</body>
