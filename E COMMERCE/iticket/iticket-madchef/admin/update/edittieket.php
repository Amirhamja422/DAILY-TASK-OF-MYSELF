...
<td>:</td>
<td>
<select name="sub_group" class="form-consex" id="sub_group" required>
                <?php
...
<td>Nature</td>
<td>:</td>
<td><input name="nature" type="text" class="form-consex" id="nature" value="<?php print $data_array[20];?>"/></td>

<td>Address</td>
<td>:</td>
<td><input name="address" type="text" class="form-consex" id="address" value="<?php print $data_array[21];?>"/></td>
</tr>
	...
	<select name="status" class="form-consex" id="status"  required >
        ...
        include 'db.php';
	          if (($_SESSION['previlege'] == 4) || ($_SESSION['previlege'] == 5)) {
	            $result1 = mysql_query("SELECT * FROM `ticket_dev`.`ticket_status` WHERE `status_name` != 'New' AND `status_name` != 'Work in progress' ORDER BY `status_name` ASC");
	          } else {
...
<td>Attachment</td>
<td>:</td>
<td style="height: 33px; color: red; font-size: 12px;"><input name="attachment" value="Browse" type="file"/></td>
</tr>
...
if(isset($_POST['ishir']))   //ishir Check
		...
		$_POST['amount']."', `details` = '".$_POST['editor1']."', `sub_group` = '".$_POST['sub_group']."', `stat` = '1' ,`status` = '".$_POST['status']."', `superiors` = '".$data_array[16]."'),\"".	
		...
		'group']."', `cus_contact` = '".$_POST['cus_phone']."',   				
		`cus_name` = '".$_POST['cus_name']."', `cus_ac` = '".$_POST['account_id']."', `cus_product` = '".$_POST['product']."', `cus_amount` = '".	
		$_POST['amount']."', `details` = '".$_POST['editor1']."', `sub_group` = '".$_POST['sub_group']."', `stat` = '1' ,`status` = '".$_POST['status']."', `superiors` = '".$data_array[16]."', `priority` = '".$_POST['priority']."', `add_phone` = '".$_POST['add_phone']."', `nature` = '".$_POST['nature']."', `address` = '".$_POST['address']."', `update_at` = '".date("Y-m-d H:i:s")."' WHERE `ticket`.`id` = $Global_id");
