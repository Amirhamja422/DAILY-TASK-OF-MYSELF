...
if(isset($_POST['addser']))
{
  ...
  if(mysql_query("INSERT INTO ticket_type (`group_id`,`type_name`) VALUES ('".$_POST['status']."','".$_POST['type']."')")){
    $suc="Service Inserted Successfully";
  }else{
    $fail="Faild to create Service";
  }
          ...
          <form class="form-horizontal" action="#" method="POST" id="myform">
            <div class="col-md-12" style="float: left; padding: 10px;">
              ...
              <div class="col-sm-8" style="float: left;">
                <select class="form-control" name="status" id="group_id">
            ...
            <div class="col-md-12" style="float: left; padding: 10px;">
              ...
              <div class="col-sm-8" style="float: left;">
                <input type="text" class="form-control" id="type" placeholder="Enter Sub-group Name" name="type" required="required">
              </div>
            </div>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-md-12">
        ...
        <div class="col-md-12">
          <div class="card">
            <div class="card-header">Service  <button class="btn btn-outline-primary btn-sm float-right" data-toggle="modal" data-target="#addservice">Add Service</button>&nbsp;<span class="float-right" id="msg" style="color: red; margin-right: 16px;"></span></div>
