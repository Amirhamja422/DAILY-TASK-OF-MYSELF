...
<form action="editmodal_st.php" method="post">
...
if(isset($_POST['NP']))
{
$results=mysql_query("UPDATE `ticket`.`sub_group` SET `group_name` = '".$_POST['group_name']."' WHERE `user_group`.`id` = ".$Global_id." LIMIT 1");
