...
<div>
    ...
    <input name="menu2" type="submit"  class="btn btn-warning btn-sm" id="menu2" onclick="document.getElementById('loder').src=''" value="Product List"/>
    <input name="menu2" type="submit"  class="btn btn-warning btn-sm" id="menu2" onclick="document.getElementById('loder').src=''" value="additional Product List"/>
