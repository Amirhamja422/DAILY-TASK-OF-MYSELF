      ...
      <?php while ($row= mysql_fetch_assoc($ticket)) { ?>
       ...
       <div class="modal-body">
        ...
        <div class="form-group">
          <div class="row">
           <div class="col-md-2"><label> Cutomer Name </label></div>
           <div class="col-md-4">
          ...
          <div class="col-md-2"> <label> Customer Phone </label></div>
          <div class="col-md-4">
   ...
   <div class="form-group">
    <div class="row">
     <div class="col-md-2"> <label> Change Status </label></div>
     <div class="col-md-4">                    
   ...
   <div class="col-md-2" style="font-size: 12px;"><label> Note </label></div>
...
<?php }   ?>
<center><strong><h4 style="color: green;">Order Details</h4></strong> </center> 
<div class="modal-body">
...
<div class="modal-body">
  ...
  <div class="row">
    ...
    <center><label style="color: green;"><strong>Update Details</strong>  </label></center>  
    ...
    <div class="col-md-6">
      ...
      <div class="card bg-light mb-3" id="card" style="max-width: 15rem; ">
        ...
        <div class="card-body" style="background-color:#F5FFFA;">
         ...
         <strong><h6 style="color: red;">  VAT : <?php echo $vat['vat']; ?></h6></strong>  
         <strong><h6 style="color: red;">  SD : <?php echo $sd['sd']; ?></h6></strong>  
         <h5 style="color: red;"> Total : <?php echo $vat['vat'] +$sum['total']+$sd['sd'] ; ?> BDT</h5>
...
<div class="modal-footer">
 ...
 <button type="button" name="updatedata"  onclick="update_ticket_insert('<?php echo $id; ?>');"   class="btn btn-primary">Update Ticket</button>
</div>
