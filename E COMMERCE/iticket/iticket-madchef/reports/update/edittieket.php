...
if(isset($_POST['ishir']))   //ishir Check
		...
		$_POST['amount']."', `details` = '".$_POST['editor1']."', `sub_group` = '".$_POST['sub_group']."', `status` = '".$_POST['status']."', `superiors` = CONCAT((select superior_id from users where id=".$_POST['to']."),\"".	
		...
		'group']."', `cus_contact` = '".$_POST['cus_phone']."',   				
		`cus_name` = '".$_POST['cus_name']."', `cus_ac` = '".$_POST['account_id']."', `cus_product` = '".$_POST['product']."', `cus_amount` = '".	
		$_POST['amount']."', `details` = '".$_POST['editor1']."', `sub_group` = '".$_POST['sub_group']."', `status` = '".$_POST['status']."', `superiors` = '".substr($_POST['cc'], 1)."' WHERE `ticket`.`id` = $Global_id");
