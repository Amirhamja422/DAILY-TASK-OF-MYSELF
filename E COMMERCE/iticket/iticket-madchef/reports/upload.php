...
<script class="jsbin" src="../admin/jquery.min.js"></script>
<script class="jsbin" src="../admin/jquery-ui.min.js"></script>
...
xmlhttp.open("GET","../admin/actionbg.php?q="+IMAGED,true);
xmlhttp.send();
		}
</script>
