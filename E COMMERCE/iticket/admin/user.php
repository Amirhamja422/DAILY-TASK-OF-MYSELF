...
<td>
<select name="concern" class="userdapa" onchange="fetch_brand(this.value);">
...
<td align="center">
<select name="gi" id="gi" class="userdapa">
...
{
include '../db.php';
$results=mysql_query("INSERT INTO `ticket`.`users` (`id`,`designation`,`superior_id`, `user_id`, `user_pass`, `user_name`, `user_email`, `user_group_id`, `previlege`,`phone`,`concern`,`brand`, `branch`) VALUES (NULL,'".$_POST['designa']."','".$_POST['superi']."', '".$_POST['uid']."','".$_POST['upass']."','".$_POST['uname']."','".$_POST['uemail']."','".$_POST['gi']."','".$_POST['prev']."','".$_POST['uphone']."','".$_POST['concern']."','".$_POST['concern']."','".$_POST['gi']."')");
