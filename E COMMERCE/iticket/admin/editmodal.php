...
<td>
<select name="concern" class="form-control" onchange="fetch_brand(this.value);">
<?php
include '../db.php';
...
if(isset($_POST['NP']))
{
$results=mysql_query("UPDATE `ticket`.`users` SET `user_id` = '".$_POST['uid']."', `user_pass` = '".$_POST['upass']."', `user_name` = '".$_POST['uname']."', `user_email` = '".$_POST['uemail']."', `user_group_id` = '".$_POST['gi']."', `previlege` = '".$_POST['prev']."', `superior_id` = '".$_POST['superi']."', `designation` = '".$_POST['designa']."', `phone` = '".$_POST['uphone']."',`brand` = '".$_POST['concern']."',`branch` = '".$_POST['ug']."', `concern` = '".$_POST['concern']."' WHERE `users`.`id` = ".$Global_id." LIMIT 1");
