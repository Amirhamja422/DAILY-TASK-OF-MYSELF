            ...
            <div class="modal fade" id="myModal" role="dialog">
              <div class="modal-dialog">
                ...
                <div class="modal-content">
                 ...
                 <div class="card mb-4">
                  <div class="card-body">
                    <p class="h5  p-2 text-center">Add Subcategory</p>
                    <form>
                 </div>

                  <div class="form-group row">
                    <label for="inputPassword" class="col-sm-3">Subcategory</label>
                      <div class="col-sm-9" style="margin-left:-23px;">                  
                       <input type="text" class="form-control" id="subcategory_name" placeholder="Enter Your Subcategory" style="width: 338px;">

                  </div>
                </div>
                    <div class="subcategory" style="text-align:center;">
                     <input class="form-control btn btn-success" style="width: 133px;margin-left: 30px;" type="sumbit" value="Add Subcategory" name="submit" id="submit" onclick="add_subcategory()">
