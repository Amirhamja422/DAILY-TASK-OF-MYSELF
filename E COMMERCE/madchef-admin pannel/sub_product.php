                ...
                <div class="modal fade" id="myModal" role="dialog">
                  <div class="modal-dialog">
                       ...
                       <div class="card mb-4">
                        <div class="card-body">
                          ...
                          <div class="form-group row">
                           ...
                           <div class="col-sm-10">
                            <select name="sub_branch_name" class="form-control input" required  id="sub_branch_name" required="required">
                            </select>  
                        ...
                        <div class="form-group row">
                         ...
                         <div class="col-sm-10">
                          <select name="newp_category_name" class="form-control input js-example-basic-single" style="width:545px;" required  id="newp_category_name" required="required" multiple data-live-search="true">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control" id="sub_product_name"  placeholder="Enter Your Product name" required="required">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="sub_size" placeholder="Enter Your Size" required="required">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="sub_price" placeholder="Enter Your Price" required="required">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="sub_vat" placeholder="Enter Your VAT" required="required">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="sub_sd" placeholder="Enter Your SD" required="required">
...
<script type="text/javascript">
  ...
  {
    var sub_product_name = document.getElementById('sub_product_name').value;
    var sub_details = document.getElementById('sub_details').value;
    var sub_branch_name = document.getElementById('sub_branch_name').value;
    var sub_brand_name = document.getElementById('sub_branch_name').value;
    if(sub_product_name == ""){
    ...
    if(sub_details == ""){
      ...
      document.getElementById('branchall').innerHTML =" ** Please fill the branch field";
      return false;
    }if(sub_brand_name == ""){
      document.getElementById('brandall').innerHTML =" ** Please fill the branch field";
      return false;
    }
