...
$i=1;
?>
<table id="datatablesSimple"  style="font-size: 13px; width: 100%;"> 
  <thead>
    <tr>
      <th>#</th>
      <th>Name</th>
...
<script type="text/javascript">
  ...
  function Update() {
    ...
    var sub_category = $('#sub_category_update').val();
    var adons_status = $('#adons_id').val();
