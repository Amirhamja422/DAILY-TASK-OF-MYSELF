                 ...
                 <div class="card mb-4">
                  <div class="card-body">
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                        <input type="text" class="form-control"  onblur="varify('branch_name','customer_number_error')"  id="branch_name" placeholder="Enter Your Branch" required="">
                      <div id="customer_number_error"></div>

                      </div>
                    </div>
                    <div class="subcategory" style="text-align:center;">
                      <input class="btn btn-success" type="sumbit" style="width: 150px;" value="Add Branch" disabled="true"  name="submit" id="insert_ticket_btn" onclick="add_branch()">
                    </div>
                  </form>
                </div>
              </div>     
...
<script type="text/javascript">
...

  {
    ...
    // alert(branch_name);
     $("#insert_ticket_btn").attr("disabled", true);
    ...
    $.ajax({
      ...
      function varify(input_id,error_field){
        var error = 0;
        // var customer_id = 10000;
        var input_value = document.getElementById(input_id).value;
        var error_field = document.getElementById(error_field);
         var btn = document.getElementById('insert_ticket_btn');

        if (input_id == 'branch_name' && input_value=="") {
          error_field.innerHTML ="<p style=\" font-size:10px; color:red; font-weight:bold\">Please Enter a Valid Branch</p>";
          error += 1;
        }else{
          error = 0;
