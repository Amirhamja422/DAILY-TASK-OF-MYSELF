    ...
    <div id="layoutSidenav">
        <div id="layoutSidenav_nav">
            <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    ...
                    <div class="nav">
                        ...
                        if ($_SESSION["previlege"]==3) {?>
                            <a class="nav-link" href="http://36.255.69.216/madchef-admin/product_list.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>Product list
                            </a>
                            ...
                            <a class="nav-link" href="http://36.255.69.216/madchef-admin/adons_product_list.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>Add_ons Product
                            </a>

                            <a class="nav-link" href="http://36.255.69.216/madchef-admin/order_list.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div>Update Order
                            </a>
                            <?php
                        }
                        if ($_SESSION["previlege"]==0) {?>
                            <a class="nav-link" href="http://36.255.69.216/madchef-admin/add_brand.php">
                                <div class="sb-nav-link-icon"><i class="fas fa-table"></i></div> Brand
                            </a>  
                ...
                <div class="sb-sidenav-footer"> i Help BD</div>
            </nav>
        </div>
    </div>
</body>
