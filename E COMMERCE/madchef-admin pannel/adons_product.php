                ...
                <div class="modal fade" id="myModal" role="dialog">
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content" style="width:687px;">
                     <div class="modal-header bg-info">
                       <h6 class="modal-title">Adons Product</h6>
                       ...
                       <div class="card mb-4">
                        ...
                        <div class="form-group row">
                         ...
                         <div class="col-sm-10">
                          <select name="adons_category_name" class="form-control input js-example-basic-single" style="width:545px;"  id="adons_category_name">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      ...
                      <span id="sizeall" class="text-danger font-weight-bold"> </span>
                    </div>
                  </div>
...
<!--                        <span id="discountall" class="text-danger font-weight-bold"> </span>
 -->
  ...
  var adons_product_name = document.getElementById('adons_product_name').value;
  var adons_details = document.getElementById('adons_details').value;
  var adons_price = document.getElementById('adons_price').value;
  // var adons_vat = document.getElementById('adons_vat').value;
  // var adons_sd = document.getElementById('adons_sd').value;
  // var adons_discount = document.getElementById('adons_discount').value;



      if(adons_product_name == ""){
     ...
     if(adons_details == ""){
      ...
      // }if(adons_vat == ""){
      //   document.getElementById('vatall').innerHTML =" ** Please fill the vat field";
      //   return false;
      // }if(adons_sd == ""){
      //   document.getElementById('sdall').innerHTML =" ** Please fill the sd field";
      //   return false;
      // }if(adons_discount == ""){
      //   document.getElementById('discountall').innerHTML =" ** Please fill the discount field";
      //   return false;
      // }
