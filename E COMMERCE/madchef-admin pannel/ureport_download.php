...
echo ("SL  \t  Brand Name  \t  Branch Name  \t  Phone Number  \t  Customer Name  \t  PRODUCT \t  STATUS \t Oeder ID \n");
...
while ($row =mysqli_fetch_assoc($results)) {
    ...
    echo $sl++ . " \t " . $row['brand'] . " \t " . $row['branch'] . " \t " . $row['phone'] . " \t " . $row['customer_name'] ." \t " . $row['product'] . " \t " . $row['order_status'] . " \t " . $row['order_id'] . " \t ";
